...
export const UNITS = ['KG', 'PCS', 'CARTON', 'BTL', 'BOX', 'PAX', 'TUBE', 'BLISTER', 'SET', 'POUCH'] as const;
...
export const INITIAL_USERS: User[] = [
  ...
  { id: 'u2', name: 'Hazlina (Manager)', username: 'hazlina', email: 'haz@halagel.com', role: 'manager', password: 'pass123' },
   { id: 'u2', name: 'Ghazali (HOD)', username: 'ghazali', email: 'ghazali@halagel.com', role: 'manager', password: 'pass123' },
   { id: 'u2', name: 'Azura (SV)', username: 'Azura', email: 'sv@halagel.com', role: 'manager', password: 'pass123' },
  ...
  { id: 'u4', name: 'Operator User', username: 'operator', email: 'operator@nexus.com', role: 'operator', password: 'password123' },
   { id: 'u4', name: 'Toothpaste (Operator)', username: 'toothpaste', email: 'operator@halagel.com', role: 'operator', password: 'pass123' },
];
